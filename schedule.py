...
class DataFormatter:
    ...
    def format_homeaway(venue, opposition, current):
        if venue == 'Away':
            return current, opposition
        elif venue == 'Home':
            return opposition, current
        else:
            return opposition, current + ' (neutral)'
...
class TeamSchedule:
    ...
    def format_team_data(self):
        ...
        for match in self.team_data:
            # match[0] = DataFormatter.format_date(match[0])
...
class PremierLeagueSchedule:
    ...
    def __init__(self, team):
        ...
        self.team_color = {
            ...
            'Burnley': '0;34;31',
            'Chelsea': '1;34;40',
            'Crystal Palace': '2;34;41',
            'Everton': '0;32;47',
            'Leeds United': '0;33;47',
