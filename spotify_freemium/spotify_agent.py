...
def multiple_playlists(spotify_user, playlist_url_string):
	...
	for playlist_url in playlist_url_string.split(','):
		...
		try:
			...
			print('Sorry. Could not obtain all playlists. Please ensure URLs entered correctly.')
